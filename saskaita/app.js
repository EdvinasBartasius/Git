    ...
    .then(data => {
        ...
        items.forEach((el, i) => {
            ...
            tr.innerHTML =
                ...
                <td>${el.quantity}</td>
                <td>${el.price}</td>
                <td>${discountToAmount(el.price, el.discount.type, el.discount.value)} ${percentageRender(el.discount.type, el.discount.value)}</td>
        ...
        trShipping.innerHTML = `
                ...
                <td data-sum>${(data.shippingPrice).toFixed(2)}</td>
            `
        ...
        trAllSum.innerHTML = `
                <td colspan="5">Viso su transporto išlaidom: </td>
        ...
        totalInvoice.innerHTML = `
                <td colspan="5">Galutinė suma su PVM: </td>
